...
_SCALABILITY_BASE_SYSTEM_INSTRUCTION = """
...
_SCALABILITY_SYSTEM_INSTRUCTION = build_calibrated_instruction(
    base_instruction=_SCALABILITY_BASE_SYSTEM_INSTRUCTION,
    boundary_reminder=(
        "Do not make pure reliability judgments unless they directly affect scaling "
        "headroom, throughput, or degradation under load."
    ),
)
